        ...
        var
            ...
            _parallaxScene = function _parallaxScene() {
              ...
              _animationHeliLoop = function() {
                _animationHeliTrip();
                setTimeout(function(){ _animationHeliReverseTrip() }, 26000);
              };

              _animationHeliLoop();
              setInterval( function(){ _animationHeliLoop()}, 53000);
              ...
              $(window).on('scroll', function() {}).one('scroll', function() {
                if ($(window).scrollTop() > 0) {
                  ...
                  _animationBirdsLoop = function() {
                    _animationBirdsTrip();
                    setTimeout(function(){ _animationBirdsReverseTrip() }, 26000);
                  };

                  _animationBirdsLoop();
                  setInterval( function(){ _animationBirdsLoop()}, 53000);
                }
              });
            ...
            _carousel = function _carousel() {
              ...
              $('.slick-slider').on('afterChange', function(event, slick, currentSlide){
                $('.carousel__drag-indicator').fadeOut('200');
                setTimeout(function(){
                  $('.carousel__drag-indicator').remove();
                }, 300);
              });
          ...
          _dragIndicator = function _dragIndicator() {
            ...
            $('.carousel__container').on({
              mouseenter: function (e) {
                var _this = $(this);
                $('.carousel__drag-indicator').css('left', e.clientX + 12).css('top', e.clientY + -55);
                $('.carousel__drag-indicator').fadeIn('200');
              },
              ...
              mouseleave: function (e) {
                $('.carousel__drag-indicator').fadeOut('100');
              }
            });
